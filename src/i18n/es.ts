export default {
  ...
  main: {
    hero: {
      title:
        'Tile & Stone <span class="font-black md:font-semibold">Expertos en Instalación en Scottsdale</span> <span class="font-bold md:font-semibold">, Paradise Valley y Áreas Circundantes de Arizona</span>',
      button1: 'Llama ahora',
      ...
      lists: [
        {
          ...
          description:
            'Instalaciones de azulejos y piedra duraderas con acabados limpios y precisión experta.',
          icon: 'house',
        },
        {
